...
# Jacobian
python3 timestamps_analisys_v2.py -f timestamp_dataset.csv -th 0.01 -g jacobian -b 0.25 --title "Call to Jacobian service" --skip_plot

# IK
python3 timestamps_analisys_v2.py -f timestamp_dataset.csv -th 0.001 -g ik -b 1 --title "Call to inverse kinematics service" -rhg one two --skip_plot
